...
# dvfs_35_percent kaldirildi: CPU %35 taban zorlamasini gerektirmez, ses kalitesi ayni kalir
SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION=eq_custom,uhq_onoff,karaoke,adapt,spk_stereo
...
# Devre disi: CPU bosken gereksiz yere yuksek frekansta kalmaz, gerektiginde hala full hiza cikar
